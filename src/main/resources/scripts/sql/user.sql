...
CREATE TABLE  `user`(
  ...
  `comment_status`  varchar(1)  CHARACTER SET utf8 COLLATE utf8_general_ci  NULL DEFAULT NULL  COMMENT '评论状态(0-禁言 1-正常)',
  `user_tag`  varchar(1)  CHARACTER SET utf8 COLLATE utf8_general_ci  NULL DEFAULT NULL  COMMENT '用户标签(0-普通用户  1-管理员)',
